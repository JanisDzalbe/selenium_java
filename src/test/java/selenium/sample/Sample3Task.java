...
public class Sample3Task {
    ...
    public void assertEqualsTask() throws Exception {
        ...
        // check that value/text of second button is "This is also a button"
        List<WebElement> buttons = driver.findElements(By.cssSelector("button, input[type='button']"));
        WebElement secondButton = buttons.get(1);

        // get label from button (either inner text or value attribute)
    ...
    public void failTask() throws Exception {
        ...
        // if loop finishes without fail(), test passes
    }
}
