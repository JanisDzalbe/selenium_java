...
//          check that value of second button is "This is also a button"
        List<WebElement> elementList = driver.findElements(By.className("text"));
...
//          check that it is False that value of second button is "This is a button"
        assertFalse(driver.findElement(By.id("buttonId")).getDomAttribute("value").equals("this is Also a Button"));
    }
...
//         contain number 190
        ...
        for (WebElement element : elementList) {
            if(element.getText().contains("109")) {
                fail();
            }
        }
    }
