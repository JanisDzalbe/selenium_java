...
//          get size text of class "test" (should be 5)
        System.out.println("size text of class \"test\" is : " + driver.findElements(By.className("test")).size());
...
//          get third text of class "test" (should be "Test Text 4")
        System.out.println("third text of class \"test\" is :" + driver.findElements(By.className("test")).get(2).getText());
    }
}
