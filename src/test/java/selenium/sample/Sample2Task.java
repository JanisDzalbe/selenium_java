...
//          get attribute "id" and "value" of button "This is also a button" using name
        System.out.println(driver.findElement(By.name("randomButton2")).getDomAttribute("value")); // "This is a button"
...
//          get third text of class "test" (should be "Test Text 4")
        ...
        System.out.println("Third element text is - " + testClassElements.get(2).getText());
    }
}
