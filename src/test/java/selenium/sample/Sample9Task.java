...
//         * success is seen instead "Green Loaded"
    ...
    public void loadGreenAndBlueBonus() {
         ...
         */
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5)); // 0
        ...
        assertFalse(driver.findElement(By.id("start_green_and_blue")).isDisplayed()); // 3
        ...
        assertFalse(driver.findElement(By.id("start_green_and_blue")).isDisplayed()); // 4
        ...
        assertFalse(driver.findElement(By.id("start_green_and_blue")).isDisplayed()); // 5
