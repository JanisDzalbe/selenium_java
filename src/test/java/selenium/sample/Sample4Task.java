...
//          check that the text is now (""), but it is not displayed
       ...
       WebElement resultField = driver.findElement(By.id("result_number"));
       numberInputField.clear();
       numberInputField.sendKeys("3");
       assertFalse(clearButton.isEnabled());
       assertFalse(resultField.isDisplayed());
       resultButton.click();
       assertTrue(resultField.isDisplayed());
       assertEquals("You entered number: \"3\"", resultField.getText());
       assertTrue(clearButton.isEnabled());
       clearButton.click();
       assertFalse(resultField.isDisplayed());
       assertEquals("",resultField.getText());
