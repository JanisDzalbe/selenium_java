...
public class Sample6Task {
    ...
    public void findElementByXPath() throws Exception {
        ...
        System.out.println(driver.findElement(By.xpath("//*[@id='test3']//*[text()='Test Text 3']")).getText());

        System.out.println(driver.findElement(By.xpath("//*[@id='test3']//*[contains(text(),'4')]")).getText());
